...
Actually this does not actually modify files, but triggers the complete 
execution chain and prints to standard output issued commands and, in case of javascript and css, 
compressed output.
