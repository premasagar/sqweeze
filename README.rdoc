...
(Mac OSX users can install the first two as Macport packages. The third (part of libjpeg) instead, has to be 
...
Download sqweeze's pre-alpha ruby gem, and install it (This assumes you have both ruby and rubygem installed). 
  
  wget http://github.com/downloads/premasagar/sqwidget-builder/sqweeze-0.0.1.gem
  gem install --local sqweeze-0.0.1.gem
